...
public class OutputRecordSchema : IOutputRecordSchema, ISavable {
    ...
    public OutputRecordSchema (Option<string> name,Option<List<object>> fields,enum_d9cba076fca539106791a4f46d198c7fcfbdb779 type,Option<string> label,object doc,LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
        ...
        string? docRoot = null)
    {
        ...
        if (doc_.ContainsKey("fields"))
        {
            try
            {
                fields = (Option<List<object>>)LoaderInstances.idmapfieldsoptional_array_of_OutputRecordFieldLoader
