...
/// </summary>
public class OutputRecordSchema : IOutputRecordSchema, ISavable {
    ...
    /// </summary>
    public OneOf<None , List<OutputRecordField>> fields { get; set; }
    ...
    public OutputRecordSchema (enum_d9cba076fca539106791a4f46d198c7fcfbdb779 type, OneOf<None , string> name = default, OneOf<None , List<OutputRecordField>> fields = default, OneOf<None , string> label = default, OneOf<None , string , List<string>> doc = default, LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
        ...
        string? docRoot = null)
    {
        ...
        if (doc_.ContainsKey("fields"))
        {
            try
            {
                fields = LoaderInstances.idmapfieldsunion_of_NullInstance_or_array_of_OutputRecordFieldLoader
        ...
        var res__ = new OutputRecordSchema(
