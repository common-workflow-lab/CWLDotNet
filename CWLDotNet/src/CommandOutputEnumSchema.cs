...
public class CommandOutputEnumSchema : ICommandOutputEnumSchema, ISavable {
    ...
    public CommandOutputEnumSchema (Option<string> name,List<string> symbols,enum_d961d79c225752b9fadb617367615ab176b47d77 type,Option<string> label,object doc,LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
        ...
        string? docRoot = null)
    {
        ...
        return new CommandOutputEnumSchema(
          symbols: symbols,
          type: type,
          label: label,
          doc: doc,
