...
public class CommandInputEnumSchema : ICommandInputEnumSchema, ISavable {
    ...
    public CommandInputEnumSchema (object name,List<string> symbols,enum_d961d79c225752b9fadb617367615ab176b47d77 type,object label,object doc,object inputBinding,LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
    ...
    static readonly HashSet<string> attr = new() { "symbols", "type", "label", "doc", "name", "inputBinding" };
}
