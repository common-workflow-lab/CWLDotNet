...
public class CommandOutputArraySchema : ICommandOutputArraySchema, ISavable {
    ...
    /// </summary>
    public OneOf<CWLType , CommandOutputRecordSchema , CommandOutputEnumSchema , CommandOutputArraySchema , string , List<OneOf<CWLType , CommandOutputRecordSchema , CommandOutputEnumSchema , CommandOutputArraySchema , string>>> items { get; set; }
    ...
    public CommandOutputArraySchema (OneOf<CWLType , CommandOutputRecordSchema , CommandOutputEnumSchema , CommandOutputArraySchema , string , List<OneOf<CWLType , CommandOutputRecordSchema , CommandOutputEnumSchema , CommandOutputArraySchema , string>>> items, enum_d062602be0b4b8fd33e69e29a841317b6ab665bc type, OneOf<None , string> name = default, OneOf<None , string> label = default, OneOf<None , string , List<string>> doc = default, LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
        ...
        string? docRoot = null)
    {
        ...
        try
        {
            items = LoaderInstances.typedslunion_of_CWLTypeLoader_or_CommandOutputRecordSchemaLoader_or_CommandOutputEnumSchemaLoader_or_CommandOutputArraySchemaLoader_or_StringInstance_or_array_of_union_of_CWLTypeLoader_or_CommandOutputRecordSchemaLoader_or_CommandOutputEnumSchemaLoader_or_CommandOutputArraySchemaLoader_or_StringInstance2
        ...
        var res__ = new CommandOutputArraySchema(
