...
public class StepInputExpressionRequirement : IStepInputExpressionRequirement, ISavable {
   ...
   */
    ...
    public StepInputExpressionRequirement (StepInputExpressionRequirement_class class_,LoadingOptions? loadingOptions = null, Dictionary<object, object>? extensionFields = null) {
        ...
        string? docRoot = null)
    {
        ...
        StepInputExpressionRequirement_class class_ = default!;
        try
        {
            class_ = (StepInputExpressionRequirement_class)LoaderInstances.uriStepInputExpressionRequirement_classLoaderFalseTrueNone
        ...
        return new StepInputExpressionRequirement(
          class_: class_,
